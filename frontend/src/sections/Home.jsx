...
const Home = () => {
  ...
  return (
    <div id="home" className="h-fit min-w-screen flex flex-col justify-center items-center px-2 sm:h-screen lg:text-xl animation-fade-in">
      <div className="flex flex-col justify-center items-center gap-6">
        ...
        <div className="flex flex-col justify-center items-center max-w-[80%] gap-4">
          ...
          {t("I am")} <span className="text-blue-300 font-bold">{t("Saadia")}</span>, {t("a")}
            ...
            <span className="ms-1" style={{ display: 'inline-block', backgroundImage: `url(assets/morocco.svg)`, width: '25px', height: '25px', backgroundSize: 'contain', backgroundRepeat: 'no-repeat', verticalAlign: 'middle' }} />
          </p>
        </div>
        <DownloadCvButton />
      </div>
