...
const About = forwardRef((props, ref) => {
  ...
  return (
    <div
      ref={ref}
      id="about"
      className="snap-start pt-16 sm:pt-3 min-w-screen flex flex-col justify-center items-center gap-2 sm:min-h-screen md:text-lg 2xl:gap-6 animation-fade-in"
    >
